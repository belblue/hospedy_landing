    ...
    <div>
        ...
        <div class="mt-24 mb-16">
            ...
            <div class="max-w-4xl mx-auto px-6 mt-20">
                <h2 class="text-3xl font-bold text-center mb-12">Cuanto te ahorras</h2>
                <div class="bg-gray-50 rounded-2xl p-8">
                    <div class="grid lg:grid-cols-2 gap-8">
                        <div class="bg-white p-6 rounded-xl border-2 border-red-200">
                            ...
                            <p class="text-gray-600 mb-4">Reserva de 100€ × 15% comision</p>
                        ...
                        <div class="bg-white p-6 rounded-xl border-2 border-green-200">
                            ...
                            <p class="text-gray-600 mb-4">Reserva de 100€ × 0% comision</p>
            ...
            <div class="max-w-5xl mx-auto px-6 mt-20">
                <h2 class="text-3xl font-bold text-center mb-12">Que incluye el motor de reservas</h2>
                <div class="grid lg:grid-cols-2 gap-8">
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Tus huespedes ven en tiempo real que fechas estan disponibles.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="flex-shrink-0 w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center">
                        ...
                        <div>
                            <h3 class="font-semibold text-lg mb-2">Precios dinamicos</h3>
                    ...
                    <div class="flex gap-4">
                        ...
                        <div>
                            ...
                            <p class="text-gray-600">Cobra depositos o el total de la reserva con la pasarela mas segura.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="flex-shrink-0 w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center">
                        ...
                        <div>
                            <h3 class="font-semibold text-lg mb-2">Confirmacion automatica</h3>
                            <p class="text-gray-600">El huesped recibe un email de confirmacion con todos los detalles.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="flex-shrink-0 w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center">
                        ...
                        <div>
                            <h3 class="font-semibold text-lg mb-2">Sincronizado con tu calendario</h3>
                            <p class="text-gray-600">Las reservas aparecen automaticamente en tu planning de Hospedy.</p>
                        </div>
                    </div>
                    <div class="flex gap-4">
                        <div class="flex-shrink-0 w-10 h-10 bg-primary/10 rounded-full flex items-center justify-center">
                        ...
                        <div>
                            <h3 class="font-semibold text-lg mb-2">Facil de integrar</h3>
                            <p class="text-gray-600">Un codigo embed que funciona en cualquier web: WordPress, Wix, tu propia pagina...</p>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div class="bg-gray-50 py-16 mt-20">
                <div class="max-w-4xl mx-auto px-6 text-center">
                    <h2 class="text-3xl font-bold mb-4">Sincronizado con tus OTAs</h2>
                    <p class="text-xl text-gray-600 mb-8">
                        Si tienes el Channel Manager activo, cuando recibes una reserva directa,
                        la disponibilidad se actualiza automaticamente en Booking, Airbnb, Expedia y todas tus OTAs.
                    </p>
            ...
            <div class="text-center mt-20 px-6">
                ...
                <p class="text-xl text-gray-600 mb-8">El motor de reservas esta incluido en tu suscripcion. Sin coste adicional.</p>
